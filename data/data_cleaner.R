# a module for food_web_data.R that cleans source data
# `a_data_cleaner()` cleans `a_data`
# `i_data_cleaner()` cleans `i_data`
# `p_data_cleaner()` cleans `p_data`


a_data_cleaner <- function(a_data){
...
i_data_cleaner <- function(i_data){
...
p_data_cleaner <- function(p_data) {
...
flatten <- function(clean_a_data, clean_i_data, clean_p_data){
